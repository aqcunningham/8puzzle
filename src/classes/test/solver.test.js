...
//import Solver, { hasBoardBeenUsed } from "../solver";
const Solver {hasBoardBeenUsed} = require('../solver')
...
describe("solver.js tests", function() {
  ...
  describe("#createPriorityQueue", function() {
    ...
    it("should return a priority-sorted list of boards", function() {
      ...
      const priority = solver.createPriorityQueue(
        [thirdBoard, firstBoard, secondBoard],
        0
      );
  ...
  describe("#getNextMove", function() {
    ...
    it("should throw a NotSolvableError if there are no possible options", function() {
      ...
      expect(() => solver.getNextMove(firstState, [firstState])).to.throw(
        "Board not solvable!"
      );
    });
    ...
    it("should return the board with the lowest priority", function() {
      ...
      firstState.board.mockNeighbors(
        highPriorityBoard,
        medPriorityBoard,
        lowPriorityBoard
      );
